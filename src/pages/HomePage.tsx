...
const stats = [
  ...
  { icon: Truck, value: '10', label: 'Marcas especializadas' },
  ...
  return (
    <>
      <SEO
        ...
        description="A melhor empresa de assistência técnica de máquinas PTA do Brasil. Manutenção preventiva, corretiva e diagnóstico avançado de plataformas elevatórias Haulotte, Genie, JLG, Manitou, Skyjack, Zoomlion, Sinoboom, LGMG, LiuGong e Hangcha. Sede em Caxias do Sul - RS. Empresa autorizada multimarcas."
              ...
              <div>
                ...
                <ul className="mt-6 space-y-3">
                  {[
                    ...
                    'Empresa autorizada — Haulotte, Genie, JLG, Manitou, Skyjack, Zoomlion, Sinoboom, LGMG, LiuGong e Hangcha',
